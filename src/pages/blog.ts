...
const blogPosts = [
  ...
  { title: 'Choosing the Right Tech Stack in 2026', cat: 'Technology', excerpt: 'React vs Vue vs Svelte? Node.js vs Go? Navigate the complex landscape of modern web development technologies.', date: 'May 3, 2026', read: '9 min', icon: '??' },
